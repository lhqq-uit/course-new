...
module.exports = {
    ...
    create: async (req, res) => {
        ...
        try {
            ...
            console.log("day la id dang nhap: "+ req.params.idUser);
            let newComment = {
    ...
    delete: async (req, res) => {
        try {
            ...
            let getData = await Comment.findById(req.params.idComment).select(
                "reply -_id"
            );
            ...
            res.status(500).send({
                message:
                    error.message || "Some error occurred while deleting the Comment.",
            });
        }
    },
    update: async (req, res) => {
        ...
        try {
            ...
            res.status(500).send({
                message:
                    error.message || "Some error occurred while updating the Comment.",
            });
        }
    },
    createChild: async (req, res) => {
        ...
        try {
            ...
            res.status(500).send({
                message:
                    error.message ||
                    "Some error occurred while creating the Comment Child.",
            });
        }
    },
    deleteChild: async (req, res) => {
        try {
            ...
            res.status(500).send({
                message:
                    error.message ||
                    "Some error occurred while Deleting the Comment Child.",
            });
        }
    },
    ...
    getAllComment: async (_req, res) => {
        try {
            ...
            res.status(500).send({
                message:
                    error.message || "Some error occurred while get all the comment.",
            });
        }
    },
    getAllCommentOfLesson: async (req, res) => {
        try {
            let getData = await Lesson.findById(req.params.idLesson)
                .populate({
                    path: "comment",
                    options: {
                        sort: {
                    ...
                    populate: {
                        path: "user reply",
                        select: "content time avatar fullname user",
                        populate: {
                            path: "user",
